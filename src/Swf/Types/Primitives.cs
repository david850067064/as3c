...
namespace As3c.Swf.Types
{
    ...
    public class Primitives
    {
        ...
        public static void WriteU30(BinaryWriter writer, U30 value)
        {
            if (0 == value._value)
            {
                writer.Write((byte)0);
        ...
        public static void WriteU30(BinaryWriter writer, uint value)
        {
            WriteU30(writer, (U30)value);
        }

        public static void WriteU30(byte[] buffer, uint start, U30 value)
        {
            if (0 == value._value)
            {
                buffer[start] = 0;
        ...
        public static void WriteU30(byte[] buffer, uint start, uint value)
        {
            WriteU30(buffer, start, (U30)value);
        }
